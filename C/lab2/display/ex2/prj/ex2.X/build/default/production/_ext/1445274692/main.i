...
void mostra_valor(int valor) {
    ...
    LATEbits.LATE2 = 1; LATEbits.LATE0 = 0;
    LATAbits.LATA2 = 0; LATAbits.LATA5 = 0;
    LATD = display_values[milhar];
    _delay((unsigned long)((2)*(48000000UL/4000.0)));

    LATEbits.LATE2 = 0; LATEbits.LATE0 = 1;
    LATAbits.LATA2 = 0; LATAbits.LATA5 = 0;
    LATD = display_values[centena];
    _delay((unsigned long)((2)*(48000000UL/4000.0)));

    LATEbits.LATE2 = 0; LATEbits.LATE0 = 0;
    LATAbits.LATA2 = 1; LATAbits.LATA5 = 0;
    LATD = display_values[dezena];
    _delay((unsigned long)((2)*(48000000UL/4000.0)));

    LATEbits.LATE2 = 0; LATEbits.LATE0 = 0;
    LATAbits.LATA2 = 0; LATAbits.LATA5 = 1;
    LATD = display_values[unidade];
    _delay((unsigned long)((2)*(48000000UL/4000.0)));
}
