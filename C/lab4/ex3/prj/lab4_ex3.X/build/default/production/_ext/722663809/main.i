# 1 "C:/Users/Samuka/Downloads/lab4/ex3/src/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/Users/Samuka/Downloads/lab4/ex3/src/main.c" 2
...
# 2 "C:/Users/Samuka/Downloads/lab4/ex3/src/main.c" 2
...
# 3 "C:/Users/Samuka/Downloads/lab4/ex3/src/main.c" 2
...
# 4 "C:/Users/Samuka/Downloads/lab4/ex3/src/main.c" 2
...
void DelayFor18TCY(void)
{
    _delay((unsigned long)((10)*(48000000UL/4000000.0)));
}

void DelayPORXLCD(void)
{
    _delay((unsigned long)((8)*(48000000UL/4000.0)));
}

void DelayXLCD(void)
{
    _delay((unsigned long)((3)*(48000000UL/4000.0)));
}
...
void main(void) {
    ...
    OpenXLCD(0b00111111 & 0b00111011);
    while(BusyXLCD());
    WriteCmdXLCD(0x01);
    DelayPORXLCD();
    putrsXLCD("Temp. LM35: ");
    ...
    while(1)
    {
        ...
        for (int i = 0; i < 6; i++) {
           for (int j = 0; j < 5; j++) {
             _delay((unsigned long)((10)*(48000000UL/4000.0)));
           }
        }
    }
}
