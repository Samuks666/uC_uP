...
void checkAllBtns (int rtn[2]) {
    if (((!PORTDbits.RD2) && (!PORTDbits.RD3)) || ((!PORTDbits.RD0) && (!PORTDbits.RD1))) {
        rtn[0] = 0;
        rtn[1] = 0;
        return;
    }

    unsigned char select = ((!PORTDbits.RD2) << 3) | ((!PORTDbits.RD3) << 2) | ((!PORTDbits.RD1) << 1) | (!PORTDbits.RD0);
    switch (select){
        case 0b0001:
            rtn[0] = 0;
            rtn[1] = 1;
